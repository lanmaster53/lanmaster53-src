...
Practical Security Services charges a flat rate of $500 per person per day for on-site training, regardless of the course. There is also a minimum on-site class size of 10 students. For example, in order to train the minimum 10 people for 3 days, it would be 10 people x 3 days x $500 = $15,000. Travel is billed as actual for on-site classes in addition to the class rate. If you are unable to meet the minimum class size, there is the option to host an open enrollment class and allow outsiders to register in order to meet the minimum (see the "Open Enrollment" section for details).
